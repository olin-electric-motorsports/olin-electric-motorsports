...
#define DMAMUX1_RGxCR(dmamux_base, rg_channel) \
    DMAMUX_RGxCR(DMAMUX1, (rg_channel))
#define DMAMUX2_RGxCR(dmamux_base, rg_channel) \
    DMAMUX_RGxCR(DMAMUX2, (rg_channel))
...
/** @defgroup dmamux_cxcr CxCR DMA request line multiplexer channel x control
register
@{*/
...
/** @defgroup dmamux_csr CSR request line multiplexer interrupt channel status
register
@{*/
...
/** @defgroup dmamux_cfr CFR request line multiplexer interrupt clear flag
register
@{*/
...
/** @defgroup dmamux_rgxcr RGxCR DMA request generator channel x control
register
@{*/
...
void dmamux_set_dma_channel_request(uint32_t dmamux, uint8_t channel,
                                    uint8_t request_id);
...
void dmamux_set_dma_request_sync_input(uint32_t dmamux, uint8_t channel,
                                       uint8_t sync_id);
void dmamux_set_dma_request_sync_pol(uint32_t dmamux, uint8_t channel,
                                     uint8_t polarity);
void dmamux_set_dma_request_sync_nbreq(uint32_t dmamux, uint8_t channel,
                                       uint8_t nbreq);
...
void dmamux_set_request_generator_trigger(uint32_t dmamux, uint8_t rg_channel,
                                          uint8_t sig_id);
...
void dmamux_enable_request_generator_trigger_overrun_interrupt(
    uint32_t dmamux, uint8_t rg_channel);
void dmamux_disable_request_generator_trigger_overrun_interrupt(
    uint32_t dmamux, uint8_t rg_channel);
uint32_t
dmamux_get_request_generator_trigger_overrun_interrupt(uint32_t dmamux,
                                                       uint8_t rg_channel);
void dmamux_clear_request_generator_trigger_overrun_interrupt(
    uint32_t dmamux, uint8_t rg_channel);
