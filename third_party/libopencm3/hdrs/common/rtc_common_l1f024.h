...
/** @defgroup rtc_isr_values RTC initialization and status register (RTC_ISR)
values
 * @ingroup rtc_registers
...
/** @defgroup rtc_tafcr_values RTC tamper and alternate function configuration
register (RTC_TAFCR) values
 * @ingroup rtc_registers
@{*/
...
void rtc_calendar_set_date(uint8_t year, uint8_t month, uint8_t day,
