...
#define HRTIM_TIMx_EEF1_EExFLTR_MASK(x) \
    (0xf << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
...
#define HRTIM_TIMx_EEF1_EExFLTR_TIMFLTR1(x) \
    (5 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_TIMFLTR2(x) \
    (6 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_TIMFLTR3(x) \
    (7 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_TIMFLTR4(x) \
    (8 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_TIMFLTR5(x) \
    (9 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_TIMFLTR6(x) \
    (10 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_TIMFLTR7(x) \
    (11 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_TIMFLTR8(x) \
    (12 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_WND_CMP2(x) \
    (13 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_WND_CMP3(x) \
    (14 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF1_EExFLTR_TIMWIN(x) \
    (15 << HRTIM_TIMx_EEF1_EExFLTR_SHIFT(x))
...
#define HRTIM_TIMx_EEF2_EExFLTR_MASK(x) \
    (0xf << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
...
#define HRTIM_TIMx_EEF2_EExFLTR_TIMFLTR1(x) \
    (5 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_TIMFLTR2(x) \
    (6 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_TIMFLTR3(x) \
    (7 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_TIMFLTR4(x) \
    (8 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_TIMFLTR5(x) \
    (9 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_TIMFLTR6(x) \
    (10 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_TIMFLTR7(x) \
    (11 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_TIMFLTR8(x) \
    (12 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_WND_CMP2(x) \
    (13 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_WND_CMP3(x) \
    (14 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
#define HRTIM_TIMx_EEF2_EExFLTR_TIMWIN(x) \
    (15 << HRTIM_TIMx_EEF2_EExFLTR_SHIFT(x))
...
#else
#warning \
    "hrtim_common_all.h should not be included explicitly, only via hrtim.h"
#endif
/** @endcond */
