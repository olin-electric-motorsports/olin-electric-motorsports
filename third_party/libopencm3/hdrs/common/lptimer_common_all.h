 ...
 *
 * @author @htmlonly &copy; @endhtmlonly 2009 Piotr Esden-Tempski
 * <piotr@esden.net>
...
/** @defgroup lptim_cfgr_ckflt LPTIM_CFGR CKFLT Configurable digital filter for
external clock
@{*/
...
/** @defgroup lptim_cfgr_trgflt LPTIM_CFGR TRGFLT Configurable digital filter
for trigger
@{*/
...
#else
#warning \
    "lptimer_common_all.h should not be included directly, only via lptimer.h"
#endif
/** @endcond */
