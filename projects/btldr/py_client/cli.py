...
"""
This is just a helpful function that takes a time delta (basically just a number
of seconds), subtracts it from the current time, and returns a string that
contains the resulting timestamp.
